import { GetModulesType, GetSubModulesType } from "../controllers/Dtos/securityPolicies.dto";
...
class SecurityService{
  ...
  async subModulesPolicies(params:GetSubModulesType):Promise<ModulesInstance[]>{
