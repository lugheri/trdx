...
export const NewCourse : React.FC<NewCourseComponent> = (props) => {
        ...
        <div className="flex flex-1">
          { newCourseId === null ? 
            ...
            <div className="flex flex-col w-full justify-center items-center">
              ...
              <div className="flex">
                <Button icon="faFolderOpen" name="Abrir Curso" btn="info"  type='outline' onClick={()=>props.setOpenCourse(newCourseId)} /> 
